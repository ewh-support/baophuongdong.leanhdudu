/*! Source available at svnroot/npm/bgmp-brandlab-belt/trunk */
!function(e) {
  function n(t) {
  ...
  var r = a(2), i = t(r), s = $(".bgbrandlab-belt");
  if (s.length > 0) {
    var l = s.get(0);
    (0, i.default)(l);
  }
  ...
  var r = a(3), i = t(r), s = function() {
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document.body, n = document.createElement("div");
    return e !== document.body && (e.innerHTML = ""), e.appendChild(n), new i.default(n);
  };
  n.default = s;
}, function(e, n, a) {
  "use strict";
  ...
  }(), s = a(4), l = t(s), o = a(6), d = t(o), c = a(7), u = t(c), b = a(8), f = t(b), p = a(9), h = t(p), _ = {
    A: "brandLabBeltA",
    B: "brandLabBeltB",
    C: "brandLabBeltC"
  }, v = "brandlab", g = v + "__content", m = v + "__content--page2", w = "disabled", y = function() {
    function e(n) {
      var a = this;
      r(this, e), window.BGMP = window.BGMP || {}, window.BGMP.pushBrandLabTease = this.addTease.bind(this),
        this.$container = (0, u.default)(n), this.chips = {
        A: null,
        B: null,
        C: null
      }, this.doRender = (0, d.default)(this._render, 150), window.BGMP.brandLabTeases && (Object.keys(_).forEach(function(e) {
        var n = _[e];
        window.BGMP.brandLabTeases[n] && a.addTease(n, window.BGMP.brandLabTeases[n]);
      }), delete window.BGMP.brandLabTeases);
    }
    return i(e, [ {
      key: "addTease",
      value: function(e, n) {
        n.style = e === _.A ? "large" : "standard";
        var a = new l.default(n);
        switch (e) {
          case _.A:
            this.chips.A = a;
            break;
      ...
      value: function() {
        var e = (0, f.default)({
          chipA: this.chips.A ? this.chips.A.render() : "",
          chipB: this.chips.B ? this.chips.B.render() : "",
          chipC: this.chips.C ? this.chips.C.render() : "",
          strings: h.default
        });
        this.$container.html(e);
        var n = (0, u.default)(".nav a", this.$container), a = n.filter(".prev"), t = n.filter(".next");
        a.addClass(w), t.removeClass(w);
        var r = (0, u.default)("." + g, this.$container);
        this._registerEventHandlers(r, a, t);
      }
    }, {
      key: "_tooltipHooverEvents",
      value: function() {
        var e = (0, u.default)("." + v + "__explainer-trigger"), n = (0, u.default)("." + v + "__explainer-content");
        e.on("mouseenter", function(n) {
          e.addClass(v + "__explainer-trigger--active");
        }), e.on("mouseleave", function(n) {
          e.removeClass(v + "__explainer-trigger--active");
        }), e.on("click", function(n) {
          e.toggleClass(v + "__explainer-trigger--active");
      ...
      value: function(e, n, a) {
        var t = this;
        this._tooltipHooverEvents(), n.on("click", function(t) {
          t.preventDefault(), e.removeClass(m), n.addClass(w), a.removeClass(w);
        }), a.on("click", function(r) {
          r.preventDefault(), e.addClass(m), n.removeClass(w), a.addClass(w);
          var i = s_gi("nytbostonglobesponsored,nytbostonglobecom");
          i.linkTrackVars = "eVar15,channel,prop1,prop6,prop43", i.linkTrackEvents = "none",
            i.tl(t, "o", "BG_SponsoredWell_Advance");
        });
      }
    } ]), e;
  }();
  ...
  }(), s = a(5), l = t(s), o = function() {
    function e(n) {
      r(this, e), this.data = n;
    }
    return i(e, [ {
      key: "render",
      value: function() {
        return this.data.image = "large" === this.data.style ? this.data.imageLarge : this.data.imageSmall,
          (0, l.default)(this.data);
      }
    } ]), e;
  }();
  n.default = o;
  ...
  e.exports = function(e) {
    var n = "undefined" != typeof _encodeHTML ? _encodeHTML : function(e) {
      var n = {
        "&": "&#38;",
        "<": "&#60;",
        ">": "&#62;",
      ...
      return function(e) {
        return e ? e.toString().replace(a, function(e) {
          return n[e] || e;
        }) : "";
      };
    }(), a = '<div class="brandlab__chip brandlab__chip--' + n(e.style) + '"> <a href="' + e.clickthrough + '" target="_blank"> <img alt="' + e.headline + '" src="' + e.image + '" class="brandlab__chip__image"> <h5 class="brandlab__chip__tag"> ' + n(e.tag) + ' <span class="brandlab__chip__advertiser">' + n(e.advertiser) + '</span> </h5> <h4 class="story-title brandlab__chip__title"> ' + n(e.headline) + ' </h4> </a> <p class="brandlab__chip__excerpt"> ' + n(e.excerpt) + " </p></div>";
    return a;
  };
}, function(e, n) {
  e.exports = function(e, n, a) {
    function t() {
      var d = Date.now() - l;
      d < n && d >= 0 ? r = setTimeout(t, n - d) : (r = null, a || (o = e.apply(s, i),
        s = i = null));
    }
    var r, i, s, l, o;
    null == n && (n = 100);
    var d = function() {
      ...
      var d = a && !r;
      return r || (r = setTimeout(t, n)), d && (o = e.apply(s, i), s = i = null), o;
    };
